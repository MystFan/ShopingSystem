namespace ShopingRequestSystem.Queries.ShopingRequests.Requesters
{
    ...
    internal class RequesterQueryRepository : QueryRepository<RequesterDetailsModel>, IRequesterQueryRepository
    {
        public RequesterQueryRepository(IDapperConnection connection)
            : base(connection)
        {
        }
