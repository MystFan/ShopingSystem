namespace ShopingRequestSystem.Queries.ShopingRequests.Requests
{
    ...
    internal class ShopingRequestDataSource : DataSource<ShopingRequestDetailsModel>, IShopingRequestDataSource
    {
        public ShopingRequestDataSource(IDapperConnection connection)
            : base(connection) 
        {
        }
