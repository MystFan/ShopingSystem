namespace ShopingRequestSystem.Domain.Common.Models
{
    ...
    public static class Guard
    {
        ...
        public static void ForStringLength<TException>(string value, int maxLength, string name = "Value")
            where TException : BaseDomainException, new()
        {
            ...
            ThrowException<TException>($"{name} must have maximum length of {maxLength} symbols.");
        }
